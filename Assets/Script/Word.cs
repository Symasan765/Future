			...
			if (cntDerayTime == DerayTime)
			{
				...
				if (cntLifeTime == LifeTime)
				{
					...
					if (ScaleFadeOut)
					{
						...
						//t = t * t * (3 - 2 * t)
						//cntFadeOutTime += cntFadeOutTime * cntFadeOutTime * (3 - 2 * cntFadeOutTime);
						...
						if (nowScale.x > 0.0f)
						{
							nowScale.x -= ScaleFadeOutSpeed.x;
							if (nowScale.x <= 0)
							{
								nowScale.x = 0;
							}
						...
						if (nowScale.y > 0.0f)
						{
							nowScale.y -= ScaleFadeOutSpeed.y;
							if (nowScale.y <= 0)
							{
								nowScale.y = 0;
							}
						...
						if (nowScale.z > 0.0f)
						{
							nowScale.z -= ScaleFadeOutSpeed.z;
							if (nowScale.z <= 0)
							{
								nowScale.z = 0;
							}
